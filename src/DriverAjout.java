...
public class DriverAjout {
	...
	public static Paie AjoutPaieCdd(int idEmp, String perpaie, float salaireMensuel, float salaireFixe, float salaireVariable) 
	{
		Connection conn = null;
		Statement stmt = null;
		try {
			...
			String sql = "INSERT INTO PaieCdd " + "VALUES ("+idEmp+",'"+ perpaie +"','" +salaireMensuel + "','" + salaireFixe+ "','" + salaireVariable + "')";
			System.out.println("Requête : " + sql);
			stmt.executeUpdate(sql);
	...
	public static Paie AjoutPaieStagiaire(int idEmp, String perpaie, float salaireFixe) 
	{
		...
		try {
			...
			String sql = "INSERT INTO PaieStagiaire " + "VALUES ("+idEmp+",'"+ perpaie +"','" + salaireFixe+ "')";
			System.out.println("Requête : " + sql);
			stmt.executeUpdate(sql);
	...
	// -------------------------------------------AJOUT PAIE ALTERNANT--------------------------------------------//

	
	public static Paie AjoutPaieAlternant(int idEmp, String perpaie, float salaireFixe) 
	{
		Connection conn = null;
		Statement stmt = null;
		try {
			...
			String sql = "INSERT INTO PaieAlternant " + "VALUES ("+idEmp+",'"+ perpaie +"','" + salaireFixe+ "')";
			System.out.println("Requête : " + sql);
			stmt.executeUpdate(sql);
