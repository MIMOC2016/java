public class Cdd extends EmployeConge {
	...
	public Cdd(String nom, String prenom, String dateEmbauche, int etabAffectation, String dateNaissance, int tel,
			String email, String dateFinContrat, float salaireFixe, float salaireVariable) {
	...
	/*
	 * public void setDateFinContrat(String dateFinContrat){ this.dateFinContrat
	 * = dateFinContrat; this.salariesorti = true; }
	 */

	public String toString() {
		return super.toString() + "\n" + "salaire Mensuel (Fixe: " + salaireFixe + " + Variable : " + salaireVariable
				+ ") = " + salaireMensuel + "\n";
	...
	public void setperpaie(String perpaie) {
