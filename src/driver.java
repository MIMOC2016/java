...
public class driver {
	...
	//-----------------------------AJOUT STAGIAIRE----------------------------------//
		public static void ConnAjoutStagiaire(int idEmp, String nom, String prenom, String dateEmbauche,int etabAffectation, String dateNaissance, int tel,String email, String ecole, String cursus, String dateFinContrat, float salaireFixe)
		{
			Connection conn = null;
			Statement stmt = null;
			try {
		...
		public static void ConnAjoutAlternant(int idEmp, String nom, String prenom, String dateEmbauche,
				...
				String dateFinContrat, String cursus, float salaireFixe) 
		{		
					Connection conn = null;
					Statement stmt = null;
					try {
